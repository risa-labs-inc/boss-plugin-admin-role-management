...
**Admin Role Management (Dynamic)** (`ai.rever.boss.plugin.dynamic.adminrolemanagement`) is a dynamic plugin for the BOSS desktop application.

Manage user roles and permissions

- **Plugin ID**: `ai.rever.boss.plugin.dynamic.adminrolemanagement`
- **Main Class**: `ai.rever.boss.plugin.dynamic.adminrolemanagement.AdminRoleManagementDynamicPlugin`
- **API Version**: 1.0.20
